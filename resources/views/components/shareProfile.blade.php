            ...
            <ul role="list" id="old_list" style="display: block" class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <li class="py-3 sm:py-4">
                    <div class="flex items-center space-x-4">
                        <input type="hidden" id="profile_id" data-profile-id="{{$post->users->id}}">
                        ...
                        <button id="share_button_profile" style="display: block" data-profile-id="{{$post->users->id}}" data-conversation_id="{{$conversation->id}}">
...
<script>
    ...
    $('#searchInputUsers').on('keyup', function(event){
        ...
        var profileId = profile_id.getAttribute('data-profile-id');
                    ...
                    data.conversations.forEach(function(chat) {
                        ...
                        <li class="py-3 sm:py-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <button id="share_button_profile" style="display: block" data-profile-id="${profileId}" data-conversation_id="${conversationId}">
                                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.61109 12.4L10.8183 18.5355C11.0462 19.6939 12.6026 19.9244 13.1565 18.8818L19.0211 7.84263C19.248 7.41555 19.2006 6.94354 18.9737 6.58417M9.61109 12.4L5.22642 8.15534C4.41653 7.37131 4.97155 6 6.09877 6H17.9135C18.3758 6 18.7568 6.24061 18.9737 6.58417M9.61109 12.4L18.9737 6.58417M19.0555 6.53333L18.9737 6.58417" stroke="#0089ee" stroke-width="2"/>
                                    </svg>
                                </button>
    ...
    $(document).ready(function(){
        $(document).on('click', '#share_button_profile', function(){
          ...
          var shared_button_profile = document.getElementById('shared_button_profile');
          $.ajax({
              url: `http://127.0.0.1:8000/profile/share/${profileId}/${conversationId}`,
              type: "GET",
                success: function(data) {
                    console.log(data);
