...
<main class="h-full w[50%] bg-gray-50 flex flex-wrap items-center justify-center overflow-x-hidden transition-transform duration-300 ease-in-out">
    <div class="border max-w-screen-md w-full bg-white mt-6 rounded-2xl p-4 mb-5">
        <div class="flex items-center justify-between relative">
            ...
            <div x-data="{ openSettings: false }">
                ...
                <div x-show="openSettings" @click.away="openSettings = false" class="bg-white absolute right-0 top-10 w-40 py-2 mt-1 border border-gray-200 shadow-2xl">
        ...
        <button onclick="toggleDescription({{ $post->id }})">Show More</button>
          <div class="mt-5 flex gap-2	 justify-center border-b pb-4 flex-wrap	">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <form id="search-input-index" action="{{route('addComment', $post->id)}}" method="POST" class="w-full ml-5 flex flex-wrap">
                    @csrf
            ...
            <div id="dropdown-menu-index" class="hidden flex flex-col items-start justify-between">
    ...
    <script>
        const dropdownButton = document.getElementById('dropdown-button-index');
