...
@foreach($users as $user)
    <div class="h-full p-8">
        ...
        <div class="bg-white rounded-lg shadow-xl pb-8">
            <div class="grid grid-cols-4">
                ...
                <button onclick="showPostsPage()" class="mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-xl pb-8" id="reelsPage">
            ...
            <div id="postsPage" class="grid w-full sm:grid-cols-2 xl:grid-cols-4 gap-6">
    ...
    <script>
        function showPostsPage() {
            document.getElementById('postsPage').classList.add('active');
            document.getElementById('reelsPage').classList.remove('active');
        }

        function showReelsPage() {
            document.getElementById('postsPage').classList.remove('active');
